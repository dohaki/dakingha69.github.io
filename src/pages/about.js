    ...
    <PageTemplate title="Hello world!">
      <Box align="center" pad={{ horizontal: 'small' }}>
        <Paragraph>
          ...
          Javascript Developer, Blockchain Enthusiast and M. Sc. Student at the
          TU Berlin.
        </Paragraph>
        <Paragraph>
          This site is unfortunately still WIP. You will find different projects
          and blog posts of mine in the near future here. Until then check out
          my &nbsp;&nbsp;
          <Anchor label="GitHub" href="https://github.com/dakingha69" />
          &nbsp;&nbsp; or &nbsp;{' '}
          <Anchor
            label="LinkedIn"
            href="https://www.linkedin.com/in/dhkim0210"
          />
          .
        </Paragraph>
